    ...
    return (
      <main>
        <nav className={styles.navbar}>
          <Logo lang="de" location={this.props.location} />
          <ul className={styles.navlist}>
            <li className={styles.navlink}>
              <Link
                id="menu-faq"
                className={styles.links}
                to={generateLink('/de/aboutus')}
            ...
            <li className={styles.navlink}>
              <Link
                id="menu-faq"
                className={styles.links}
                to={generateLink('/de/frequently-asked-questions')}
                activeClassName={styles.activenav}
              >
        ...
        >
          <div className="mobile-menu-links">
            ...
            <Link
              ...
              style={{ textDecoration: 'none', color: 'inherit' }}
            >
              <h4 className="mobile-menu-link">Homezone</h4>
            </Link>
            <Link
              id="mobile-menu-faq"
              to={generateLink('/de/frequently-asked-questions')}
