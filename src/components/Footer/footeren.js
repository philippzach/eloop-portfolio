...
const Footer = () => (
  <footer>
    <div className="flexcontainer">
      <img src={Logo} className="logo" alt="" title="" loading="lazy"/>
      <div>
        <ul className="menu">
          <li>
            <Link id="footer-legal" to="/en/legal" className="link link-black">
              Legal Information
            </Link>
          </li>
          <li>
            <Link id="footer-terms" to="/en/terms" className="link link-black">
              Terms of Service
            </Link>
          </li>
          <li>
