...
const Post = ({ data: { prismicPost } }) => {
  ...
  const disqusConfig = {
    url: `https://eloop.at/de/blog/${prismicPost.uid}`,
  ...
  return (
    <Layout>
      <Seo
        ...
        pathname={`/de/blog/${prismicPost.uid}`}
        date={data.date}
      />
      ...
      <article>
        ...
        <Share data={`https://eloop.at/de/blog/${prismicPost.uid}`} />
        <Container>
          <React.Fragment>
