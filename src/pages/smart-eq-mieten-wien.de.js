    ...
    <Layout location={location.search}>
      <Helmet>
        <link
          rel='alternate'
          hreflang='de'
          href='https://eloop.at/de/smart-eq-mieten-wien/'
        />
        <link
          rel='alternate'
          hreflang='en'
          href='https://eloop.at/en/smart-eq-rent-vienna/'
        />
      </Helmet>
      <Seo
        title='Smart EQ pro Minute, Stunde & Tag in Wien und Umgebung mieten'
        desc='Mit Eloop kannst du günstig Elektrische Smarts in Wien mieten. Egal ob du einen Smart EQ pro Minute, Stunde oder Tag brauchst'
        ...
        <Container>
          <div className={styles.heading}>
            <h1 className={styles.title}>
              <span>Elektrische Smarts Mieten in Wien</span>
            </h1>
            <h2 className={styles.description}>
              Du bist auf der Suche nach einem günstigen und umweltfreundlichen
              Kleinwagen? Hier kannst du den Smart EQ für Stunden, Tage, Wochen
              und Monate mieten.
            </h2>
            <Link
              id='cta-landing'
...
'
        ...
        <FlexContainer>
          <Left>
            <Img
              ...
              alt='smart eq mieten wien Eloop'
            />
          </Left>
          <Right>
            <List>
              <h2>Smart EQ Technik</h2>
              <Item style={style1}>
                100% elektrische E-Autos von Eloop in Wien mieten
              </Item>
              <Item style={style1}>82 PS (60kW), 0-60km/h - 4,9 sek.</Item>
              <Item style={style1}>130 km/h Top Speed</Item>
              <Item style={style1}>Klimaautomatik</Item>
              <Item style={style1}>120km Reichweite</Item>
              <Item style={style1}>
                Ladeleistung: bis zu 22kw - Typ2(AC) - 2 Sitzplätze
              </Item>
            </List>
          </Right>
        </FlexContainer>
        <Spacer />
        <CallToActionOne
          title='Smart EQ ab 7,90€/Stunde, 59,90€/Tag oder 339€/Woche mieten'
      ...
      <Container>
        ...
        <CallToAction
          title='Smart EQ pro Tag, Woche oder Monat mieten'
...
export const query = graphql`
  query {
    header: file(relativePath: { eq: "smart-eq-mieten-wien.jpg" }) {
      childImageSharp {
        fluid(
          maxWidth: 2450
    ...
    cover2: file(relativePath: { eq: "smart_ed4_mieten_wien.jpg" }) {
      childImageSharp {
        fluid(
          maxWidth: 1450
          traceSVG: { background: "#fff", color: "#49deb5" }
